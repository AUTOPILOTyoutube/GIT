...
Не рекомендуется, чтобы ссылка (указатьль на метку) указывала на коммит. Ссылка должна указывать на ветку. Перевести ссылку на ветку:  
git checkout master
- master - имя ветки
...
- Создаём удалённый репозиторий на гитхаб  
- В локальном репозитории добавляем новый сервер:  
git remote add origin [url]
- Переименовываем нашу ветку в "main"  
git branch -M main
- Загрузить изменения из локальной ветки "main" в удалённую ветку "main" на сервер, который называется "origin":  
